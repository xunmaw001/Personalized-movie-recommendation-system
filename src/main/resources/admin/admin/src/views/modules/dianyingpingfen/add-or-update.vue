		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="电影编号" prop="dianyingbianhao">
					<el-input v-model="ruleForm.dianyingbianhao" placeholder="电影编号" clearable  :readonly="ro.dianyingbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="电影编号" prop="dianyingbianhao">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-if="type!='info'"  label="电影分类" prop="dianyingfenlei">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="select" v-if="type!='info'"  label="电影评分" prop="dianyingpingfen">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else class="input" label="电影评分" prop="dianyingpingfen">
					<el-input v-model="ruleForm.dianyingpingfen"
						placeholder="电影评分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="date" v-if="type!='info'" label="评分日期" prop="pingfenriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="input" v-else-if="ruleForm.pingfenriqi" label="评分日期" prop="pingfenriqi">
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-if="type!='info'"  label="评分内容" prop="pingfenneirong">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.pingfenneirong" label="评分内容" prop="pingfenneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.pingfenneirong = this.ruleForm.pingfenneirong.replace(reg,'../../../springboot6n498/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
